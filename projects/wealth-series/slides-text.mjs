...
export const SLIDES = [
  ...
  [19, `An AI analyzing 86 stocks across 15 sectors, with a signal track record you can verify yourself. <break time="300ms"/> Not a robo-advisor allocating to 6 ETFs. Not a chatbot picking stocks. <break time="300ms"/> A complete AI signal publication, starting at $25,000.`, 0],
  ...
  [40, `This is not a stock screener. This is not a robo-advisor buying 6 ETFs. <break time="300ms"/> This is institutional-grade AI signal publishing, the kind of analysis that typically costs tens of thousands of dollars from Wall Street research desks, available to you starting at $25,000.`, 0],
  ...
  [42, `Here's how it works. 3 steps. <break time="300ms"/> Step one: you choose your tier. Atlas at $25,000. Titan at $50,000. Or Everest at $100,000. Each tier gives you access to AI signal portfolios calibrated to different risk levels, high growth, balanced, and defensive.`, 0],
  [43, `Step two: you subscribe to the Wealth Series signal publication. You get access to the full AI dashboard, weekly signal reports, reasoning notes, allocation grids, and performance tracking. <break time="400ms"/> TradeAlgo publishes the signals. You decide how to act on them through your own brokerage.`, 0],
  ...
  [48, `Atlas is your starting point. $25,000. 3 portfolios, high growth, balanced, and defensive. The high-growth portfolio returned 43.9 percent in the past year. <break time="300ms"/> This is where you access the AI's signals with a meaningful but manageable commitment.`, 0],
  [49, `Titan increases the commitment to $50,000 and gives you broader diversification, up to 40 stocks per portfolio. Dynamic Upside returned 45.5 percent.`, 0],
  ...
  [51, `All 3 tiers are 3-year licenses. And there's a reason for that. The AI's signals are designed to track over full market cycles. Short-term volatility is noise. 3 years gives the system room to navigate full market cycles, earnings seasons, Fed decisions, corrections, and rallies. <break time="400ms"/> This is a commitment to a data-driven process, the same way institutional investors think about time horizons.`, 0],
  ...
  [53, `$25,000 is a significant commitment. <break time="400ms"/> It is. And it should be, this is a serious signal publication, not a newsletter with vague tips. <break time="300ms"/> But here's what's important: your subscription gives you access to 11 AI-powered signal portfolios, each one publishing detailed buy, sell, and hold signals with written reasoning, every single week. <break time="300ms"/> The top portfolio's signals produced returns of 43.9 percent in its first year. Every signal is documented. Every reasoning note is available for you to read.`, 0],
  ...
  [57, `3 years is a long commitment. <break time="400ms"/> The 3-year license is designed to align with how markets actually work. AI-driven signal strategies perform over full cycles, not weeks. Last month, high-risk portfolios drew down 3 to 4 percent. That's normal. Over a year, those same portfolios returned 43 to 52 percent. <break time="300ms"/> The AI's signals need time to track through earnings seasons, Fed decisions, corrections, and rallies. A 3-year window is how institutional investors think, and it's why the results compound.`, 0],
